...
public class ScrollGesture_Latest {
...
//        driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().textContains(\"WebView\"))")); // this code also works.
...
//      //  WebElement element = driver.findElement(AppiumBy.accessibilityId("WebView3"));
